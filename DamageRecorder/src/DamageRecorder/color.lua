_G.Color = {}; 
Color["silver"] = Turbine.UI.Color( .75, .75, .75 );
Color["blue"] = Turbine.UI.Color( 0, 0, 1 );
...
Color["green"] = Turbine.UI.Color( 0, 1, 0 );
...
Color["gold"] = Turbine.UI.Color( 0.8, 0.6, 0.1 );
...
Color["ftransparent"] = Turbine.UI.Color ( 0, 0, 0, 0 ); -- Fully transparent
Color["black"] = Turbine.UI.Color( 1, 0, 0, 0 );
Color["5black"] = Turbine.UI.Color( 0.5, 0, 0, 0 );
Color["3black"] = Turbine.UI.Color( 0.3, 0, 0, 0 );
Color["white"] = Turbine.UI.Color( 1, 1, 1 );
